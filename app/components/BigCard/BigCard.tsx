...
function BigCard({
  ...
  return (
    <Container className="hover:grayscale">
      <Link href={href} className="flex flex-col mdl:h-[300px] xl:h-[360px] mdl:flex-row w-full gap-3">
        ...
        <div className="flex flex-col items-start justify-evenly gap-4 mdl:gap-2 lg:gap-4">
          ...
          <H3 className="capitalize font-semibold mdl:text-3xl xl:text-4xl">{title}</H3>
